    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-sm-8">
                ...
                <h3>Pengguna</h3>
                <br>
                <a href="pengguna_tambah.php" class="btn btn-primary">Tambah Data pengguna</a>
                <br>
                <hr>
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><? echo $data["nama_pengguna"]; ?></td>
                                <td><a href="pengguna_ubah.php?id=<? echo $data["username"]; ?>" class="badge badge-warning">ubah</a>
                                    <a href="pengguna_hapus.php?id=<? echo $data["username"]; ?>" class="badge badge-danger">Hapus</a></td>
