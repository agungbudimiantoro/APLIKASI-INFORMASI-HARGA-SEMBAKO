    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-sm-8">
                ...
                <h3>Barang</h3>
                <br>
                <a href="barang_tambah.php" class="btn btn-primary">Tambah Data Barang</a> <a href="barang_laporan.php" class="btn btn-success">CETAK LAPORAN</a>
                <br>
                <hr>
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><a href="barang_ubah.php?id=<? echo $data["kd_barang"]; ?>" class="badge badge-warning">ubah</a>
                                    <a href="barang_hapus.php?id=<? echo $data["kd_barang"]; ?>" class="badge badge-danger">Hapus</a></td>
                            <?
                        endwhile;
                            ?>
                    </tbody>
